class AuthService {
    ...
    get identity() {
        return LostTimeWeb.getIdentity();
    }

    set identity(i) {
        LostTimeWeb.setIdentity(i);
    }
    ...
    login(selectedProvider) {
        ...
        var popup = window.open(provider.endpoint, "Connexion à LostTimeWeb", "menubar=no, status=no, scrollbars=no, menubar=no, width=700, height=700");
    }
