<template>
    <div id="about" class="row backgrey">
        <div class="col-md-5 col-md-offset-2">
            ...
            <p>Soyez maître de votre destin !</p>
        </div>
        <div class="col-md-4">
            <h2>Réalisation</h2>
            <ul>
                <li>Guillaume Elisabeth</li>
                <li>Julie Lacognata</li>
                <li>Yacine Chergui</li>
                <li>Pierre Koré</li>
                <li>Quentin Vanbutsele</li>
            </ul>
            <p>Réalisé dans le cadre de nos études à IN'TECH, Semestre 5 (premier semestre 2017)</p>            
        </div>
        <div class="col-md-12 col-md-offset-6">
            <h2>Contact</h2>
            <p><a href="mailto:lostime@intechinfo.fr">Nous contacter</a></p>
        </div>
    </div>
</template>